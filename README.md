# EmotionScope: Emotion Classifier from scratch using Keras on the Kaggle FER-2013 (Facial Emotion Recognition) Dataset

# ![EmotionScope: Emotion Classifier from scratch using Keras on the Kaggle FER-2013 (Facial Emotion Recognition) Dataset](data/animations/CV_Project_01_EmotionScope-01.gif)
